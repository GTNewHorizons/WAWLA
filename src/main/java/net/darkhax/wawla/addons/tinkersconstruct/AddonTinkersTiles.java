...
public class AddonTinkersTiles implements IWailaDataProvider {
    ...
    public ItemStack getWailaStack(IWailaDataAccessor data, IWailaConfigHandler cfg) {
        ...
        // Hides landmines
        if (cfg.getConfig(CONFIG_HIDE_LANDMINES) && data.getTileEntity() != null
                && Utilities.compareByClass(classBlockLandmine, data.getBlock().getClass())) {
        ...
        if (data.getBlock() != null && data.getTileEntity() != null) {
            ...
            if (Utilities.compareTileEntityByClass(data.getTileEntity(), classDryingRackLogic)) {
                ...
                if (cfg.getConfig(CONFIG_DRYER_TIME)) {
                    ...
                    double percent = Utilities.round(
                            Utilities.getProgression(
                                    data.getNBTData().getInteger("Time"),
                                    data.getNBTData().getInteger("MaxTime")),
                            2);
            ...
            if (Utilities.compareTileEntityByClass(data.getTileEntity(), classFurnaceLogic)) {
                ...
                if (cfg.getConfig(CONFIG_BURN_TIME)) {
                    ...
                    if (burnTime > 0 && cfg.getConfig("wawla.furnace.burntime")) tip.add(
    ...
    /**
     * This is a special method added to allow the ModuleHarvest to apply to tinkers construct tools and ores.
     * 
