...
public class AddonGenericTooltips {
    ...
    public void onTooltip(ItemTooltipEvent event) {
        ...
        if (event.entityPlayer != null && event.entityPlayer.worldObj != null) {
            ...
            boolean isShifting = Minecraft.getMinecraft().gameSettings
                    .isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindSneak);
            ...
            if (event.entityPlayer.worldObj.isRemote) {
                ...
                if (item instanceof ItemEnchantedBook) {
                    ...
                    if (isShifting) {
                        ...
                        if (ench != null) {
                            ...
                            else Utilities.wrapStringToList(
                                    StatCollector.translateToLocal("description." + ench.getName()),
                                    45,
                                    false,
                                    event.toolTip);
                        }
                    ...
                    else event.toolTip.add(StatCollector.translateToLocal("tooltip.wawla.shiftEnch"));
                }
                ...
                // Armor Points
                    ...
                    event.toolTip.add(
                            StatCollector.translateToLocal("tooltip.wawla.armorprot") + ": "
